/**
 * config.js
 * Satu-satunya file yang perlu diedit saat menambah pilihan kostum.
 * id  -> unik, tanpa spasi
 * name-> teks yang tampil ke pengguna
 * src -> lokasi file gambar (null = pilihan "kosong")
 */
...
const LAYERS = [
  {
    ...
    options: [
      ...
      { id: "skin-03", name: "Fair", src: "assets/skin/skin-03.png" }, // upload file-nya nanti
    ],
  },
  {
    id: "hat",
    ...
    options: [
      ...
      { id: "hat-03", name: "Obsidian Veil", src: "assets/hat/hat-03.png" }, // tadinya nganggur
    ],
  },
  {
    id: "clothes",
    ...
    options: [
      ...
      { id: "clothes-04", name: "Golden Regalia", src: "assets/clothes/clothes-04.png" }, // tadinya nganggur
    ],
  },
  {
    id: "glasses",
  ...
  },
  {
    ...
    options: [
      ...
      { id: "ritual-02", name: "Verdigris Seal", src: "assets/ritual/ritual-02.png" }, // upload file-nya nanti
    ],
  },
  {
    id: "background",
