...
//   belakang ke paling depan:
//   background (paling belakang) -> skin -> hat -> clothes -> glasses
//   -> ritual (paling depan, menutupi semua lapisan lain)
//   Jangan diubah kecuali kamu memang ingin mengubah urutan
//   tumpukan visual avatar.
...
const LAYERS = [
  ...
  },
  {
    ...
    label: "Ritual",
    options: [
      { id: "none", name: "Tanpa Efek Ritual", src: null },
      { id: "ritual-01", name: "Aura Emas", src: "assets/ritual/ritual-01.png" },
      { id: "ritual-02", name: "Segel Verdigris", src: "assets/ritual/ritual-02.png" },
    ],
  },
];
